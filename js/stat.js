...
var printScore = function(ctx, time) {
...
var printWinners = function(ctx, players, time) {
  var GIST_X = CLOUD_X + 40;
  var GIST_Y = CLOUD_Y + CLOUD_HEIGHT - 40;
  var NAME_POS = CLOUD_Y + CLOUD_HEIGHT - 30;
  ...
  for (var i = 0; i < players.length; i++) {
    ...
    ctx.fillText(Math.floor(time[i]), GIST_X, GIST_Y - heightGistPlayer - 20);
    ...
    printNames(ctx, players[i], GIST_X, NAME_POS);
    GIST_X += 100;
  }
